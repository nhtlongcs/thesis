...
\title{Semi-supervised Organ Segmentation\\in 3D Volume with \\Mask-Propagation Refinement}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \include{content/appendices/advisor-comment}
% \include{content/appendices/reviewer-comment}
% \include{content/appendices/acknowledgements}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Your English abstracts, each in one file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \input{content/appendices/appendices}
...
% \bibliographyown{references/refs} % Hinh nhu la cai nay a, cai nay la LOP 
\appendix
\import{content/appendices}{app-paper}
\end{document}
